...
public class HTMLLexer extends Lexer {
	...
	public static final int
		OPEN_TAG=1, CLOSE_TAG=2, SELF_CLOSING=3, SLASH=4, TAG_NAME=5, EQUALS=6, 
		STRING=7, TEXT=8, COMMENT=9, WS=10;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"OPEN_TAG", "CLOSE_TAG", "SELF_CLOSING", "SLASH", "TAG_NAME", "EQUALS", 
			"STRING", "TEXT", "COMMENT", "WS"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "OPEN_TAG", "CLOSE_TAG", "SELF_CLOSING", "SLASH", "TAG_NAME", "EQUALS", 
			"STRING", "TEXT", "COMMENT", "WS"
		};
	}
